...
import { features, faqs } from "@/data/dataHub";
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <section className="container mx-auto py-20 text-center">
        ...
        <Link href="/login">
          <Button size="lg" variant="outline" className="text-black hover:bg-black hover:text-gray-100 cursor-pointer">
            Login
          </Button>
        </Link>
      </section>
      ...
      <section className="py-20 text-center px-5 bg-gray-900">
        <div className="container mx-auto">
          ...
          <Link href="/onboarding">
            <Button size="lg" className="animate-bounce bg-amber-50 text-black hover:bg-amber-100 cursor-pointer">
