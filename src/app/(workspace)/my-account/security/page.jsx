...
const Security = () => {
  ...
  return (
    <div className="flex min-h-[65vh] flex-col items-center justify-center gap-6 rounded-3xl">
      <div className="flex sm:w-[80%] md:w-[300px] lg:w-[400px] min-w-[250px] flex-shrink-0 flex-col gap-6 rounded-3xl">
